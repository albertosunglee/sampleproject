...
export default class AccountDataTable extends LightningElement {
  ...
  processData() {
    ...
    if (this.searchTerm) {
      ...
      console.log("AccountDataTable: Applying search filter", {
        searchTerm: this.searchTerm
      });
    ...
    if (this.sortedBy) {
      ...
      console.log("AccountDataTable: Sorting applied", {
        field: this.sortedBy,
        direction: this.sortDirection,
        columnType: this.columns.find((col) => col.fieldName === this.sortedBy)
          ?.type
      });
    }
  ...
  handlePrevious() {
    if (this.currentPage > 1) {
      ...
      console.log(
        "AccountDataTable: Previous page clicked but already on first page"
      );
    }
  }
  ...
  handleNext() {
    if (this.currentPage < this.totalPages) {
      ...
      console.log(
        "AccountDataTable: Next page clicked but already on last page"
      );
    }
  }
